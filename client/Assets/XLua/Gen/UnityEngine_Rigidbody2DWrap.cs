...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRigidbody2DWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 34, 23, 21);
        ...
        static int _m_DOMove(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody2D.DOMove!");
        ...
        static int _m_DOMoveX(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody2D.DOMoveX!");
        ...
        static int _m_DOMoveY(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody2D.DOMoveY!");
        ...
        static int _m_DOJump(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody2D.DOJump!");
        ...
        static int _m_DOPath(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 7&& translator.Assignable<UnityEngine.Vector2[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<DG.Tweening.PathType>(L, 4)&& translator.Assignable<DG.Tweening.PathMode>(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)&& translator.Assignable<System.Nullable<UnityEngine.Color>>(L, 7)) 
                {
                    UnityEngine.Vector2[] _path = (UnityEngine.Vector2[])translator.GetObject(L, 2, typeof(UnityEngine.Vector2[]));
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                ...
                if(gen_param_count == 6&& translator.Assignable<UnityEngine.Vector2[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<DG.Tweening.PathType>(L, 4)&& translator.Assignable<DG.Tweening.PathMode>(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)) 
                {
                    UnityEngine.Vector2[] _path = (UnityEngine.Vector2[])translator.GetObject(L, 2, typeof(UnityEngine.Vector2[]));
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    DG.Tweening.PathType _pathType;translator.Get(L, 4, out _pathType);
                ...
                if(gen_param_count == 5&& translator.Assignable<UnityEngine.Vector2[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<DG.Tweening.PathType>(L, 4)&& translator.Assignable<DG.Tweening.PathMode>(L, 5)) 
                {
                    UnityEngine.Vector2[] _path = (UnityEngine.Vector2[])translator.GetObject(L, 2, typeof(UnityEngine.Vector2[]));
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    DG.Tweening.PathType _pathType;translator.Get(L, 4, out _pathType);
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2[]>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<DG.Tweening.PathType>(L, 4)) 
                {
                    UnityEngine.Vector2[] _path = (UnityEngine.Vector2[])translator.GetObject(L, 2, typeof(UnityEngine.Vector2[]));
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                    DG.Tweening.PathType _pathType;translator.Get(L, 4, out _pathType);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody2D.DOPath!");
        ...
        static int _m_DOLocalPath(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody2D.DOLocalPath!");
