...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemGCWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 18, 1, 0);
			Utils.RegisterFunc(L, Utils.CLS_IDX, "GetAllocatedBytesForCurrentThread", _m_GetAllocatedBytesForCurrentThread_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetAllocatedBytesForCurrentThread_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = System.GC.GetAllocatedBytesForCurrentThread(  );
