...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemCollectionsGenericDictionary_2_SystemStringUnityEngineGameObject_Wrap 
    {
        ...
        static int _m_set_Item(RealStatePtr L)
        {
		    try {
                ...
                
                {
					...
					string key = LuaAPI.lua_tostring(L, 2);
					UnityEngine.GameObject gen_value = (UnityEngine.GameObject)translator.GetObject(L, 3, typeof(UnityEngine.GameObject));
        ...
        static int _m_TrimExcess(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to System.Collections.Generic.Dictionary<string, UnityEngine.GameObject>.TrimExcess!");
