...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningPluginsFloatPluginWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DG.Tweening.Plugins.FloatPlugin);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new DG.Tweening.Plugins.FloatPlugin();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Plugins.FloatPlugin constructor!");
        ...
        static int _m_Reset(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Plugins.FloatPlugin gen_to_be_invoked = (DG.Tweening.Plugins.FloatPlugin)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.FloatOptions> _t = (DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.FloatOptions>)translator.GetObject(L, 2, typeof(DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.FloatOptions>));
        ...
        static int _m_SetFrom(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.FloatOptions>>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.FloatOptions> _t = (DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.FloatOptions>)translator.GetObject(L, 2, typeof(DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.FloatOptions>));
                ...
                if(gen_param_count == 5&& translator.Assignable<DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.FloatOptions>>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)) 
                {
                    DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.FloatOptions> _t = (DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.FloatOptions>)translator.GetObject(L, 2, typeof(DG.Tweening.Core.TweenerCore<float, float, DG.Tweening.Plugins.Options.FloatOptions>));
                    float _fromValue = (float)LuaAPI.lua_tonumber(L, 3);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Plugins.FloatPlugin.SetFrom!");
        ...
        static int _m_GetSpeedBasedDuration(RealStatePtr L)
        {
		    try {
                ...
                {
                    DG.Tweening.Plugins.Options.FloatOptions _options;translator.Get(L, 2, out _options);
                    float _unitsXSecond = (float)LuaAPI.lua_tonumber(L, 3);
                    float _changeValue = (float)LuaAPI.lua_tonumber(L, 4);
        ...
        static int _m_EvaluateAndApply(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DG.Tweening.Core.DOGetter<float> _getter = translator.GetDelegate<DG.Tweening.Core.DOGetter<float>>(L, 5);
                    DG.Tweening.Core.DOSetter<float> _setter = translator.GetDelegate<DG.Tweening.Core.DOSetter<float>>(L, 6);
                    float _elapsed = (float)LuaAPI.lua_tonumber(L, 7);
                    float _startValue = (float)LuaAPI.lua_tonumber(L, 8);
                    float _changeValue = (float)LuaAPI.lua_tonumber(L, 9);
