...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningPluginsStringPluginWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DG.Tweening.Plugins.StringPlugin);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new DG.Tweening.Plugins.StringPlugin();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Plugins.StringPlugin constructor!");
        ...
        static int _m_SetFrom(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Plugins.StringPlugin gen_to_be_invoked = (DG.Tweening.Plugins.StringPlugin)translator.FastGetCSObj(L, 1);
            
            
			    int gen_param_count = LuaAPI.lua_gettop(L);
            
                if(gen_param_count == 3&& translator.Assignable<DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> _t = (DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>)translator.GetObject(L, 2, typeof(DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>));
                ...
                if(gen_param_count == 5&& translator.Assignable<DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>>(L, 2)&& (LuaAPI.lua_isnil(L, 3) || LuaAPI.lua_type(L, 3) == LuaTypes.LUA_TSTRING)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)) 
                {
                    DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions> _t = (DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>)translator.GetObject(L, 2, typeof(DG.Tweening.Core.TweenerCore<string, string, DG.Tweening.Plugins.Options.StringOptions>));
                    string _fromValue = LuaAPI.lua_tostring(L, 3);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Plugins.StringPlugin.SetFrom!");
        ...
        static int _m_GetSpeedBasedDuration(RealStatePtr L)
        {
		    try {
                ...
                {
                    DG.Tweening.Plugins.Options.StringOptions _options;translator.Get(L, 2, out _options);
                    float _unitsXSecond = (float)LuaAPI.lua_tonumber(L, 3);
                    string _changeValue = LuaAPI.lua_tostring(L, 4);
        ...
        static int _m_EvaluateAndApply(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DG.Tweening.Core.DOGetter<string> _getter = translator.GetDelegate<DG.Tweening.Core.DOGetter<string>>(L, 5);
                    DG.Tweening.Core.DOSetter<string> _setter = translator.GetDelegate<DG.Tweening.Core.DOSetter<string>>(L, 6);
                    float _elapsed = (float)LuaAPI.lua_tonumber(L, 7);
                    string _startValue = LuaAPI.lua_tostring(L, 8);
                    string _changeValue = LuaAPI.lua_tostring(L, 9);
