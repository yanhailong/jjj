...
namespace XLua.CSObjectWrap
{
    ...
    public class AssetManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 28, 1, 1);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "LoadSprite_List", _m_LoadSprite_List);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_LoadSprite_List(RealStatePtr L)
        {
		    try {
                ...
                {
                    string _abName = LuaAPI.lua_tostring(L, 2);
                    System.Collections.Generic.List<string> _assetName = (System.Collections.Generic.List<string>)translator.GetObject(L, 3, typeof(System.Collections.Generic.List<string>));
                    
                        var gen_ret = gen_to_be_invoked.LoadSprite_List( _abName, _assetName );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _abName = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.LoadSprite_List( _abName );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to AssetManager.LoadSprite_List!");
