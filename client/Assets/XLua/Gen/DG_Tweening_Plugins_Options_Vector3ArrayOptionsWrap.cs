...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningPluginsOptionsVector3ArrayOptionsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DG.Tweening.Plugins.Options.Vector3ArrayOptions);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(DG.Tweening.Plugins.Options.Vector3ArrayOptions));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Plugins.Options.Vector3ArrayOptions constructor!");
        ...
        static int _m_Reset(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Plugins.Options.Vector3ArrayOptions gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
