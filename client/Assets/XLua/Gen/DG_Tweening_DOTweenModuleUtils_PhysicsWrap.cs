		    ...
		    try {
                ...
                
                {
                    UnityEngine.Component _target = (UnityEngine.Component)translator.GetObject(L, 1, typeof(UnityEngine.Component));
                        ...
                        var gen_ret = DG.Tweening.DOTweenModuleUtils.Physics.HasRigidbody2D( _target );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Component _target = (UnityEngine.Component)translator.GetObject(L, 1, typeof(UnityEngine.Component));
                        ...
                        var gen_ret = DG.Tweening.DOTweenModuleUtils.Physics.HasRigidbody( _target );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    DG.Tweening.PathMode _pathMode;translator.Get(L, 6, out _pathMode);
                        ...
                        var gen_ret = DG.Tweening.DOTweenModuleUtils.Physics.CreateDOTweenPathTween( _target, _tweenRigidbody, _isLocal, _path, _duration, _pathMode );
