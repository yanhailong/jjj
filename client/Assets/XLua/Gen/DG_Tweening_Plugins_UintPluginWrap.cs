...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningPluginsUintPluginWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DG.Tweening.Plugins.UintPlugin);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new DG.Tweening.Plugins.UintPlugin();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Plugins.UintPlugin constructor!");
        ...
        static int _m_Reset(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Plugins.UintPlugin gen_to_be_invoked = (DG.Tweening.Plugins.UintPlugin)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    DG.Tweening.Core.TweenerCore<uint, uint, DG.Tweening.Plugins.Options.UintOptions> _t = (DG.Tweening.Core.TweenerCore<uint, uint, DG.Tweening.Plugins.Options.UintOptions>)translator.GetObject(L, 2, typeof(DG.Tweening.Core.TweenerCore<uint, uint, DG.Tweening.Plugins.Options.UintOptions>));
        ...
        static int _m_SetFrom(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<DG.Tweening.Core.TweenerCore<uint, uint, DG.Tweening.Plugins.Options.UintOptions>>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    DG.Tweening.Core.TweenerCore<uint, uint, DG.Tweening.Plugins.Options.UintOptions> _t = (DG.Tweening.Core.TweenerCore<uint, uint, DG.Tweening.Plugins.Options.UintOptions>)translator.GetObject(L, 2, typeof(DG.Tweening.Core.TweenerCore<uint, uint, DG.Tweening.Plugins.Options.UintOptions>));
                ...
                if(gen_param_count == 5&& translator.Assignable<DG.Tweening.Core.TweenerCore<uint, uint, DG.Tweening.Plugins.Options.UintOptions>>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)) 
                {
                    DG.Tweening.Core.TweenerCore<uint, uint, DG.Tweening.Plugins.Options.UintOptions> _t = (DG.Tweening.Core.TweenerCore<uint, uint, DG.Tweening.Plugins.Options.UintOptions>)translator.GetObject(L, 2, typeof(DG.Tweening.Core.TweenerCore<uint, uint, DG.Tweening.Plugins.Options.UintOptions>));
                    uint _fromValue = LuaAPI.xlua_touint(L, 3);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Plugins.UintPlugin.SetFrom!");
        ...
        static int _m_GetSpeedBasedDuration(RealStatePtr L)
        {
		    try {
                ...
                {
                    DG.Tweening.Plugins.Options.UintOptions _options;translator.Get(L, 2, out _options);
                    float _unitsXSecond = (float)LuaAPI.lua_tonumber(L, 3);
                    uint _changeValue = LuaAPI.xlua_touint(L, 4);
        ...
        static int _m_EvaluateAndApply(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    DG.Tweening.Core.DOGetter<uint> _getter = translator.GetDelegate<DG.Tweening.Core.DOGetter<uint>>(L, 5);
                    DG.Tweening.Core.DOSetter<uint> _setter = translator.GetDelegate<DG.Tweening.Core.DOSetter<uint>>(L, 6);
                    float _elapsed = (float)LuaAPI.lua_tonumber(L, 7);
                    uint _startValue = LuaAPI.xlua_touint(L, 8);
                    uint _changeValue = LuaAPI.xlua_touint(L, 9);
