...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningPluginsOptionsVectorOptionsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DG.Tweening.Plugins.Options.VectorOptions);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				{
				    translator.Push(L, default(DG.Tweening.Plugins.Options.VectorOptions));
			        return 1;
				}
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Plugins.Options.VectorOptions constructor!");
        ...
        static int _m_Reset(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Plugins.Options.VectorOptions gen_to_be_invoked;translator.Get(L, 1, out gen_to_be_invoked);
