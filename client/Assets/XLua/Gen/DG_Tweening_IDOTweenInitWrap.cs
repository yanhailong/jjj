...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningIDOTweenInitWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DG.Tweening.IDOTweenInit);
        ...
        {
            return LuaAPI.luaL_error(L, "DG.Tweening.IDOTweenInit does not have a constructor!");
        }
        ...
        static int _m_SetCapacity(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.IDOTweenInit gen_to_be_invoked = (DG.Tweening.IDOTweenInit)translator.FastGetCSObj(L, 1);
