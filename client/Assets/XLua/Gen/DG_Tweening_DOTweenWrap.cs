...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningDOTweenWrap 
    {
        ...
        static int _g_get_safeModeLogBehaviour(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.PushDGTweeningCoreEnumsSafeModeLogBehaviour(L, DG.Tweening.DOTween.safeModeLogBehaviour);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_nestedTweenFailureBehaviour(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.PushDGTweeningCoreEnumsNestedTweenFailureBehaviour(L, DG.Tweening.DOTween.nestedTweenFailureBehaviour);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
