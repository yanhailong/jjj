...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningPluginsVector3ArrayPluginWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(DG.Tweening.Plugins.Vector3ArrayPlugin);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new DG.Tweening.Plugins.Vector3ArrayPlugin();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Plugins.Vector3ArrayPlugin constructor!");
        ...
        static int _m_Reset(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.Plugins.Vector3ArrayPlugin gen_to_be_invoked = (DG.Tweening.Plugins.Vector3ArrayPlugin)translator.FastGetCSObj(L, 1);
            
            
                
                {
                    DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3[], DG.Tweening.Plugins.Options.Vector3ArrayOptions> _t = (DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3[], DG.Tweening.Plugins.Options.Vector3ArrayOptions>)translator.GetObject(L, 2, typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3[], DG.Tweening.Plugins.Options.Vector3ArrayOptions>));
        ...
        static int _m_SetFrom(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3[], DG.Tweening.Plugins.Options.Vector3ArrayOptions>>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3[], DG.Tweening.Plugins.Options.Vector3ArrayOptions> _t = (DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3[], DG.Tweening.Plugins.Options.Vector3ArrayOptions>)translator.GetObject(L, 2, typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3[], DG.Tweening.Plugins.Options.Vector3ArrayOptions>));
                ...
                if(gen_param_count == 5&& translator.Assignable<DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3[], DG.Tweening.Plugins.Options.Vector3ArrayOptions>>(L, 2)&& translator.Assignable<UnityEngine.Vector3[]>(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 5)) 
                {
                    DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3[], DG.Tweening.Plugins.Options.Vector3ArrayOptions> _t = (DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3[], DG.Tweening.Plugins.Options.Vector3ArrayOptions>)translator.GetObject(L, 2, typeof(DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3[], DG.Tweening.Plugins.Options.Vector3ArrayOptions>));
                    UnityEngine.Vector3[] _fromValue = (UnityEngine.Vector3[])translator.GetObject(L, 3, typeof(UnityEngine.Vector3[]));
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DG.Tweening.Plugins.Vector3ArrayPlugin.SetFrom!");
        ...
        static int _m_GetSpeedBasedDuration(RealStatePtr L)
        {
		    try {
                ...
                {
                    DG.Tweening.Plugins.Options.Vector3ArrayOptions _options;translator.Get(L, 2, out _options);
                    float _unitsXSecond = (float)LuaAPI.lua_tonumber(L, 3);
                    UnityEngine.Vector3[] _changeValue = (UnityEngine.Vector3[])translator.GetObject(L, 4, typeof(UnityEngine.Vector3[]));
        ...
        static int _m_EvaluateAndApply(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Vector3[] _startValue = (UnityEngine.Vector3[])translator.GetObject(L, 8, typeof(UnityEngine.Vector3[]));
                    UnityEngine.Vector3[] _changeValue = (UnityEngine.Vector3[])translator.GetObject(L, 9, typeof(UnityEngine.Vector3[]));
