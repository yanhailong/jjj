...
namespace Coffee.UIParticleInternal
{
        ...
        , IPreprocessBuildWithReport
    {
        ...
        protected static void SetDefaultSettings(PreloadedProjectSettings asset)
        {
            ...
            {
                if (!AssetDatabase.IsValidFolder("Assets/ThirdTools/ParticleEffect/ProjectSettings"))
                {
                    AssetDatabase.CreateFolder("Assets/ThirdTools/ParticleEffect", "ProjectSettings");
                }

                var assetPath = $"Assets/ThirdTools/ParticleEffect/ProjectSettings/{GetDefaultName(type, false)}.asset";
