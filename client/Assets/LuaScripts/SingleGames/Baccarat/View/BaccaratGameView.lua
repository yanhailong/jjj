...
function BaccaratGameView:InitComponents()
    ...
    --self.img_BankerCard1=ComponentUtilGet.Image(self.transform,"content/TopRoot/ator_DealCards/obj_BankerCardRoot/ator_BankerCard1/img_BankerCard1");
    ...
    --self.img_BankerCard2=ComponentUtilGet.Image(self.transform,"content/TopRoot/ator_DealCards/obj_BankerCardRoot/ator_BankerCard2/img_BankerCard2");
    ...
    --self.img_BankerCard3=ComponentUtilGet.Image(self.transform,"content/TopRoot/ator_DealCards/obj_BankerCardRoot/ator_BankerCard3/img_BankerCard3");
    ...
    self.tmp_BankerPoint=ComponentUtilGet.TextMeshProUGUI(self.transform,"content/TopRoot/ator_DealCards/obj_BankerCardRoot/BankerCardType/obj_BankerPoints/tmp_BankerPoint");
    ...
    --self.img_PlayerCard1=ComponentUtilGet.Image(self.transform,"content/TopRoot/ator_DealCards/obj_PlayerCardRoot/ator_PlayerCard1/img_PlayerCard1");
    ...
    --self.img_PlayerCard2=ComponentUtilGet.Image(self.transform,"content/TopRoot/ator_DealCards/obj_PlayerCardRoot/ator_PlayerCard2/img_PlayerCard2");
    ...
    --self.img_PlayerCard3=ComponentUtilGet.Image(self.transform,"content/TopRoot/ator_DealCards/obj_PlayerCardRoot/obj_PlayerCard3/img_PlayerCard3");
    ...
    self.tmp_PlayerPoint=ComponentUtilGet.TextMeshProUGUI(self.transform,"content/TopRoot/ator_DealCards/obj_PlayerCardRoot/PlayerCardType/obj_PlayerPoints/tmp_PlayerPoint");
