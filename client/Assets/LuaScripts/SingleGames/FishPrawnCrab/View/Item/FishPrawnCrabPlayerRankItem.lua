...
--@desc 
--
---@class FishPrawnCrabPlayerRankItem
local FishPrawnCrabPlayerRankItem=Class("FishPrawnCrabPlayerRankItem")

function FishPrawnCrabPlayerRankItem:ctor(go)
    self.gameObject = go
    self.transform=self.gameObject.transform
    self.rankIcon = ComponentUtilGet.Image(self.transform,"img_rank")
    self.rankText = ComponentUtilGet.TextMeshProUGUI(self.transform,"txt_rank")
...
---
---更新玩家排名信息
function FishPrawnCrabPlayerRankItem:UpdateUI(data)
    ...
    self.nameTxt.text = data.name or data.nickname or ""
    self.rankText.text = data.rank or 0
end

return FishPrawnCrabPlayerRankItem