CtrlNames.USDollarExpressCar="USDollarExpressCar";
CtrlManager.CtrlsCollection[CtrlNames.USDollarExpressCar]={};
CtrlManager.CtrlsCollection[CtrlNames.USDollarExpressCar].ctrl =require "SingleGames/USDollarExpress/Ctrl/USDollarExpressCarCtrl";
