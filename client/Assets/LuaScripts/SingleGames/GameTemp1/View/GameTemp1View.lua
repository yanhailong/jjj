...
---
---@class GameTemp1View:BaseView
local GameTemp1View=Class("GameTemp1View",BaseView)

---初始化panel
function GameTemp1View:InitView()
	---@type GameTempCtrl1
    self.ctrl=self.ctrl
	self:InitComponents()
    self:InitWheelRoot()
...
---获取组件
function GameTemp1View:InitComponents()
...
function GameTemp1View:InitWheelRoot()
    self.wheelRootList={}
    for i = 1, 5 do
...
---清空组件
function GameTemp1View:ClearComponents()
...
---初始化View数据
function GameTemp1View:InitPanelData(args)
	
end

---关闭界面
function GameTemp1View:Close()   
    self.super.Close(self);
end

return GameTemp1View
