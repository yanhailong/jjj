...
pb_DragonTigerFight.NotifyRoomReadyWait = 20610
--- 响应,msgID=0x13003,desc=红黑大战结算信息
pb_DragonTigerFight.NotifyRedBlackWarSettleInfo = 77827
--- 响应,msgID=0x13081,desc=通知红黑大战桌上信息
pb_DragonTigerFight.NotifyRedBlackWarInfo = 77953
--- 响应,msgID=0x14001,desc=通知龙虎斗桌上信息
pb_DragonTigerFight.NotifyLoongTigerWarInfo = 81921
--- 响应,msgID=0x14002,desc=龙虎斗结算信息
pb_DragonTigerFight.NotifyLoongTigerWarSettleInfo = 81922
--- 请求,msgID=0x18001,desc=请求获取百家乐房间摘要信息
pb_DragonTigerFight.ReqBaccaratTableSummaryList = 98305
--- 请求,msgID=0x18002,desc=请求获取百家乐房间摘要信息
pb_DragonTigerFight.ReqBaccaratTableSummary = 98306
--- 请求,msgID=0x18004
pb_DragonTigerFight.ReqBaccaratTableInfo = 98308
--- 请求,msgID=0x18005,desc=在游戏中请求加入房间
pb_DragonTigerFight.ReqJoinRoomInGame = 98309
--- 请求,msgID=0x18006,desc=在游戏中请求退出房间
pb_DragonTigerFight.ReqExitRoomInGame = 98310
--- 响应,msgID=0x18081,desc=断线重连 通知玩家百家乐牌桌信息
pb_DragonTigerFight.NotifyBaccaratTableInfo = 98433
--- 响应,msgID=0x18082,desc=返回房间摘要信息
pb_DragonTigerFight.RespBaccaratTableSummaryList = 98434
--- 响应,msgID=0x18083,desc=返回房间单条摘要信息
pb_DragonTigerFight.NotifyBaccaratTableSummary = 98435
--- 响应,msgID=0x18084,desc=返回百家乐桌上信息 首次进入
pb_DragonTigerFight.RespBaccaratTableInfo = 98436
--- 响应,msgID=0x18085,desc=百家乐通知下注开始
pb_DragonTigerFight.NotifyBaccaratBetStart = 98437
--- 响应,msgID=0x18086,desc=百家乐结算信息
pb_DragonTigerFight.NotifyBaccaratSettlementInfo = 98438
--- 响应,msgID=0x18087,desc=在游戏中返回加入房间
pb_DragonTigerFight.RespJoinRoomInGame = 98439
--- 响应,msgID=0x18088,desc=在游戏中返回退出房间
pb_DragonTigerFight.RespExitRoomInGame = 98440
--- 请求,msgID=0x20001,desc=请求下注
pb_DragonTigerFight.ReqBet = 131073
--- 请求,msgID=0x20003,desc=请求获取百人牌桌的玩家信息
pb_DragonTigerFight.ReqTablePlayerInfo = 131075
--- 请求,msgID=0x20004
pb_DragonTigerFight.ReqRoomBaseInfo = 131076
--- 响应,msgID=0x20081,desc=请求下注返回
pb_DragonTigerFight.NotifyPlayerBet = 131201
