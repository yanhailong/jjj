...
pb_BirdsAnimals.NotifyRoomReadyWait = 20610
--- 响应,msgID=0x13003,desc=红黑大战结算信息
pb_BirdsAnimals.NotifyRedBlackWarSettleInfo = 77827
--- 响应,msgID=0x13081,desc=通知红黑大战桌上信息
pb_BirdsAnimals.NotifyRedBlackWarInfo = 77953
--- 响应,msgID=0x14001,desc=通知龙虎斗桌上信息
pb_BirdsAnimals.NotifyLoongTigerWarInfo = 81921
--- 响应,msgID=0x14002,desc=龙虎斗结算信息
pb_BirdsAnimals.NotifyLoongTigerWarSettleInfo = 81922
--- 响应,msgID=0x16081,desc=飞禽走兽桌面信息，下注，结算，断线重连
pb_BirdsAnimals.NotifyAnimalsTableInfo = 90241
--- 响应,msgID=0x16082,desc=通知飞禽走兽结算信息
pb_BirdsAnimals.NotifyAnimalsSettlement = 90242
--- 请求,msgID=0x18001,desc=请求获取百家乐房间摘要信息
pb_BirdsAnimals.ReqBaccaratTableSummaryList = 98305
--- 请求,msgID=0x18002,desc=请求获取百家乐房间摘要信息
pb_BirdsAnimals.ReqBaccaratTableSummary = 98306
--- 请求,msgID=0x18004
pb_BirdsAnimals.ReqBaccaratTableInfo = 98308
--- 请求,msgID=0x18005,desc=在游戏中请求加入房间
pb_BirdsAnimals.ReqJoinRoomInGame = 98309
--- 请求,msgID=0x18006,desc=在游戏中请求退出房间
pb_BirdsAnimals.ReqExitRoomInGame = 98310
--- 响应,msgID=0x18081,desc=断线重连 通知玩家百家乐牌桌信息
pb_BirdsAnimals.NotifyBaccaratTableInfo = 98433
--- 响应,msgID=0x18082,desc=返回房间摘要信息
pb_BirdsAnimals.RespBaccaratTableSummaryList = 98434
--- 响应,msgID=0x18083,desc=返回房间单条摘要信息
pb_BirdsAnimals.NotifyBaccaratTableSummary = 98435
--- 响应,msgID=0x18084,desc=返回百家乐桌上信息 首次进入
pb_BirdsAnimals.RespBaccaratTableInfo = 98436
--- 响应,msgID=0x18085,desc=百家乐通知下注开始
pb_BirdsAnimals.NotifyBaccaratBetStart = 98437
--- 响应,msgID=0x18086,desc=百家乐结算信息
pb_BirdsAnimals.NotifyBaccaratSettlementInfo = 98438
--- 响应,msgID=0x18087,desc=在游戏中返回加入房间
pb_BirdsAnimals.RespJoinRoomInGame = 98439
--- 响应,msgID=0x18088,desc=在游戏中返回退出房间
pb_BirdsAnimals.RespExitRoomInGame = 98440
--- 请求,msgID=0x20001,desc=请求下注
pb_BirdsAnimals.ReqBet = 131073
--- 请求,msgID=0x20003,desc=请求获取百人牌桌的玩家信息
pb_BirdsAnimals.ReqTablePlayerInfo = 131075
--- 请求,msgID=0x20004
pb_BirdsAnimals.ReqRoomBaseInfo = 131076
--- 响应,msgID=0x20081,desc=请求下注返回
pb_BirdsAnimals.NotifyPlayerBet = 131201
--- 响应,msgID=0x20083,desc=返回牌桌玩家列表的下注信息
pb_BirdsAnimals.RespTablePlayerInfo = 131203
--- 响应,msgID=0x20088,desc=通知押注类房间玩家信息变化
pb_BirdsAnimals.NotifyTableRoomPlayerInfoChange = 131208
--- 响应,msgID=0x20089
pb_BirdsAnimals.NotifyPhaseChangInfo = 131209
...
PBHelper.LoadPB('SingleGames/BirdsAnimals/Protol','room')
PBHelper.LoadPB('SingleGames/BirdsAnimals/Protol','table')