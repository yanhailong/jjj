---@class RoyalWarRoad
local RoyalWarRoad = Class("RoyalWarRoad")
---@type RoyalWarConfig
...
function RoyalWarRoad:Init(ZhuPanContent,DaLuContent,DaluZiluContent,XiaoLuContent,YueYouLuContent)
    ---@type ObjectPoolUtil
...
---初始化大路预制体表
function RoyalWarRoad:InitDaLuTable()
    for i = 1, 6*70 do
...
---初始化大路大眼路预制体表
function RoyalWarRoad:InitDaLuZiLuTable()
    for i = 1, 6*70 do
...
---初始化大路大眼路预制体表
function RoyalWarRoad:InitXiaoLuTable()
    for i = 1, 6*70 do
...
---初始化曱甴路预制体表
function RoyalWarRoad:InitYueYouLuTable()
    for i = 1, 6*70 do
...
---大眼路刷新显示
function RoyalWarRoad:AddDaYanZiLuTableShow()
...
---小路刷新显示
function RoyalWarRoad:AddXiaoLuTableShow()
    local curList = #self.DaLuDataTable;
    local lastPiece= self.DaLuDataTable[curList]
    ---@type RoyalWarDaLuItem
    local lastItem = lastPiece[#lastPiece][3];
...
---曱甴刷新显示
function RoyalWarRoad:AddYueYouLuTableShow()
    local curList = #self.DaLuDataTable;
    local lastPiece= self.DaLuDataTable[curList]
    ---@type RoyalWarDaLuItem
    local lastItem = lastPiece[#lastPiece][3];
...
---清空所有路表
function RoyalWarRoad:CloseLuTable()
