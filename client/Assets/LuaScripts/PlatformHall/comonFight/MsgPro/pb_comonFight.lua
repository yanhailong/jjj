...
pb_comonFight.NotifyRoomReadyWait = 20610
--- 响应,msgID=0x13003,desc=红黑大战结算信息
pb_comonFight.NotifyRedBlackWarSettleInfo = 77827
--- 响应,msgID=0x13081,desc=通知红黑大战桌上信息
pb_comonFight.NotifyRedBlackWarInfo = 77953
--- 响应,msgID=0x14001,desc=通知龙虎斗桌上信息
pb_comonFight.NotifyLoongTigerWarInfo = 81921
--- 响应,msgID=0x14002,desc=龙虎斗结算信息
pb_comonFight.NotifyLoongTigerWarSettleInfo = 81922
--- 响应,msgID=0x16081,desc=飞禽走兽桌面信息，下注，结算，断线重连
pb_comonFight.NotifyAnimalsTableInfo = 90241
--- 响应,msgID=0x16082,desc=通知飞禽走兽结算信息
pb_comonFight.NotifyAnimalsSettlement = 90242
--- 响应,msgID=0x17081,desc=豪车俱乐部桌面信息，下注，结算，断线重连
pb_comonFight.NotifyLuxuryCarClubTableInfo = 94337
--- 响应,msgID=0x17082,desc=通知豪车俱乐部结算信息
pb_comonFight.NotifyLuxuryCarClubSettlement = 94338
--- 请求,msgID=0x18001,desc=请求获取百家乐房间摘要信息
pb_comonFight.ReqBaccaratTableSummaryList = 98305
--- 请求,msgID=0x18002,desc=请求获取百家乐房间摘要信息
pb_comonFight.ReqBaccaratTableSummary = 98306
--- 请求,msgID=0x18004
pb_comonFight.ReqBaccaratTableInfo = 98308
--- 请求,msgID=0x18005,desc=在游戏中请求加入房间
pb_comonFight.ReqJoinRoomInGame = 98309
--- 请求,msgID=0x18006,desc=在游戏中请求退出房间
pb_comonFight.ReqExitRoomInGame = 98310
--- 响应,msgID=0x18081,desc=断线重连 通知玩家百家乐牌桌信息
pb_comonFight.NotifyBaccaratTableInfo = 98433
--- 响应,msgID=0x18082,desc=返回房间摘要信息
pb_comonFight.RespBaccaratTableSummaryList = 98434
--- 响应,msgID=0x18083,desc=返回房间单条摘要信息
pb_comonFight.NotifyBaccaratTableSummary = 98435
--- 响应,msgID=0x18084,desc=返回百家乐桌上信息 首次进入
pb_comonFight.RespBaccaratTableInfo = 98436
--- 响应,msgID=0x18085,desc=百家乐通知下注开始
pb_comonFight.NotifyBaccaratBetStart = 98437
--- 响应,msgID=0x18086,desc=百家乐结算信息
pb_comonFight.NotifyBaccaratSettlementInfo = 98438
...
pb_comonFight.ReqTablePlayerInfo = 131075
--- 请求,msgID=0x20004
pb_comonFight.ReqRoomBaseInfo = 131076
--- 响应,msgID=0x20081,desc=请求下注返回
pb_comonFight.NotifyPlayerBet = 131201
--- 响应,msgID=0x20083,desc=返回牌桌玩家列表的下注信息
pb_comonFight.RespTablePlayerInfo = 131203
--- 响应,msgID=0x20088,desc=通知押注类房间玩家信息变化
pb_comonFight.NotifyTableRoomPlayerInfoChange = 131208
--- 响应,msgID=0x20089
pb_comonFight.NotifyPhaseChangInfo = 131209
...
PBHelper.LoadPB('PlatformHall/comonFight/Protol','room')
PBHelper.LoadPB('PlatformHall/comonFight/Protol','table')